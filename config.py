...
MESSAGES = {
    "IDENTITY": (
        "เป็นบอทผู้ช่วยของห้อง MTC ม.4/2 นะ "
        "ช่วยได้หลายอย่างเลย ไม่ว่าจะเป็นตารางเรียน ลิงก์เว็บโรงเรียน "
        "เช็คเกรด ดูเวลาคาบถัดไป หรือจะถามอะไรก็ได้ผ่าน AI"
    ),
    "AI_DISABLED": "ตอนนี้ AI ยังไม่เปิดใช้งานนะ",
    "AI_NO_RESPONSE": "AI ตอบไม่ได้ตอนนี้ ลองใหม่อีกทีนะ",
    "AI_ERROR": "AI มีปัญหาเชื่อมต่อชั่วคราว ลองใหม่อีกทีได้เลย",
    "RATE_LIMITED": "ใจเย็นๆ น้า พิมพ์รัวไปนิดนึง รอแป๊บนะ",
    "INVALID_MESSAGE": "รับได้แค่ข้อความนะ ลองพิมพ์มาได้เลย",
    "NO_CLASS_TODAY": "วันนี้หยุด ไม่มีเรียนนะ พักให้เต็มที่เลย",
    "NO_CLASS_LEFT": "วันนี้หมดคาบแล้ว กลับบ้านได้เลย",
    "ACTION_ERROR": "เกิดข้อผิดพลาดนิดนึง ลองใหม่อีกทีนะ",
}
