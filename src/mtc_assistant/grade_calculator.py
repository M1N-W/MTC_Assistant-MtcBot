...
def handle_gpa_calculation_command(user_message: str, user_id: str = None) -> str:
    ...
    if not subjects:
        return (
            "🎯 วิธีคำนวณ GPA มีหลายแบบเลยครับ!\n\n"
            "📌 แบบทีละวิชา (แนะนำสุด)\n"
            "  1️⃣ เริ่ม GPA\n"
            "  2️⃣ เพิ่มวิชา คณิต 3 4\n"
            "  3️⃣ เพิ่มวิชา ฟิสิกส์ 3 3.5\n"
            "  4️⃣ คำนวณ GPA\n\n"
    ...
    try:
        ...
        return f"แงงง ระบบคำนวณไม่ถูกเลยฮะ เช็คสมการให้อีกทีได้มั้ยเอ่ย? 🧐 ({str(e)})"
...
def get_grade_calculator_help() -> str:
    """Return help text"""
    return (
        "🎯 มาคำนวณเกรดกัน! ทำได้ง่ายมากเลยครับ\n\n"
        "📌 วิธีที่ 1 — ทีละวิชา (แนะนำสุด)\n"
        "  1️⃣ เริ่ม GPA\n"
        "  2️⃣ เพิ่มวิชา คณิต 3 4\n"
        "  3️⃣ เพิ่มวิชา ฟิสิกส์ 3 3.5\n"
        "  4️⃣ คำนวณ GPA\n\n"
